      ...
      <div className='h-full overflow-scroll lg:flex' >
        ...
        <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2  ' >
          ...
          <div className='flex flex-col gap-12' >
            {/* Image */}
            <div>
              <Image src="https://images.pexels.com/photos/775358/pexels-photo-775358.jpeg?auto=compress&cs=tinysrgb&w=800" alt="prpfile" width={112} height={112} className='rounded-full object-cover w-28 h-28 ' />
            </div>
            {/* text */}
            <div className='flex flex-col gap-12 ' >
              {/* BIOGRAPHY TITLE */}
              <motion.h1 
              style
              className='text-2xl font-bold' >BIOGRAPHY</motion.h1>
              {/* BIOGRAPHY DESC */}
              <p className='text-lg' >Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum harum quibusdam cupiditate nobis accusamus sed aut aperiam, reiciendis numquam! Voluptas voluptatibus obcaecati dolore itaque suscipit! Vel doloremque numquam quam nihil.</p>
              {/* BIOGRAPHY QUOTE */}
              <span className='text-base italic ' >Lorem ipsum dolor sit amet consectetur adipisicing elit.</span>
              {/* BIOGRAPHY SING SVG */}
              <div className='self-end' >  {/* Yazıyı sayfanın sonuna ayarlar */}
                <svg
                  width="185"
                  height="77"
                  viewBox="0 0 370 114"
              ...
              <motion.svg
                ...
                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="50" height="50" style={{ opacity: "0.44792", transform: "translateY(3.09899px)" }}><path d="M5 15C5 16.8565 5.73754 18.6371 7.05029 19.9498C8.36305 21.2626 10.1435 21.9999 12 21.9999C13.8565 21.9999 15.637 21.2626 16.9498 19.9498C18.2625 18.6371 19 16.8565 19 15V9C19 7.14348 18.2625 5.36305 16.9498 4.05029C15.637 2.73754 13.8565 2 12 2C10.1435 2 8.36305 2.73754 7.05029 4.05029C5.73754 5.36305 5 7.14348 5 9V15Z" stroke="#000000" strokeWidth="1"></path><path d="M12 6V14" stroke="#000000" strokeWidth="1"></path><path d="M15 11L12 14L9 11" stroke="#000000" strokeWidth="1"></path></motion.svg>
            </div>
          </div>
          {/* SKILLS Container */}
          <div>
            <div className='flex flex-col gap-12'>
              ...
              <motion.h1
                initial={{ x: "-300px" }}
                animate={{ x: 0 }}
                transition={{ delay: 0.2 , margin:"-100px" }}
              ...
              <motion.div
                ...
                <div className='rounded p-2 cursor-pointer bg-black text-white hover:text-black hover:bg-white' >Javascript</div>
                <div className='rounded p-2 cursor-pointer bg-black text-white hover:text-black hover:bg-white' >HTML</div>
                <div className='rounded p-2 cursor-pointer bg-black text-white hover:text-black hover:bg-white' >React.js</div>
                <div className='rounded p-2 cursor-pointer bg-black text-white hover:text-black hover:bg-white' >Tailwind CSS</div>
                <div className='rounded p-2 cursor-pointer bg-black text-white hover:text-black hover:bg-white' >Next.js</div>
                <div className='rounded p-2 cursor-pointer bg-black text-white hover:text-black hover:bg-white' >Redux</div>
                <div className='rounded p-2 cursor-pointer bg-black text-white hover:text-black hover:bg-white' >Vite</div>
                <div className='rounded p-2 cursor-pointer bg-black text-white hover:text-black hover:bg-white' >Framer Motion</div>
                <div className='rounded p-2 cursor-pointer bg-black text-white hover:text-black hover:bg-white' >Git</div>
              </motion.div>
              {/*SKILLS Scroll SVG */}
              <motion.svg
                initial={{ opacity: 0.2, y: 0 }}
            ...
            <div
              ...
              <div className='flex justify-between h-48' >
                ...
                <div className='w-1/3  ' >
                  ...
                  {/* JOB DESC */}
                  <div className='italic p-3 text-sm' >I led web development, offering expertise in JavaScript frameworks.</div>
                  {/* JOB DATE */}
                ...
                <div className='w-1/6  flex justify-center ' >
                  ...
                  <div className='w-1 h-full bg-gray-600 relative' >
                    {/* LINE CIRCLE */}
                    <div className='absolute w-5 h-5 rounded-full bg-white ring-4 ring-red-600 -left-2 ' ></div>
                  </div>
                </div>
                {/* RIGHT */}
